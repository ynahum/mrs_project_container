...
namespace tf_relay_node_namespace
{
    class TfRelayNode : public rclcpp::Node
    {
    public:
        explicit TfRelayNode(const rclcpp::NodeOptions &options)
            : Node("tf_relay_node", options)
        {
...
RCLCPP_COMPONENTS_REGISTER_NODE(tf_relay_node_namespace::TfRelayNode)
